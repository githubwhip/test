...
def main():
    ...
    st.set_page_config(page_title="사회 학습 도우미", page_icon="🌻")  # 웹 페이지 제목과 아이콘 설정
    st.image('image01.png')  # 상단에 이미지를 표시
    st.title("_:red[2024-25986 정유미 (사회 학습용 챗봇]_ 🏫")  # 제목 표시 (에너지 학습 도우미)
    st.header("😶5-2(사회의 새로운 변화와 오늘날의 우리) 전용 챗봇!", divider='rainbow')  # 주의사항 표시
